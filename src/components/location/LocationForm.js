    ...
    <form className="locationForm">
      ...
      <fieldset>
        <div className="form-group">
          ...
          <input value={location.name} type="text" id="name" onChange={handleControlledInputChange} required autoFocus className="form-control" placeholder="Location name" defaultvalue={location.name}/>
        </div>
      </fieldset>
      <fieldset>
        <div className="form-group">
          <label htmlFor="name">Location address :</label>
          <input value={location.address} type="text" id="address" name="address" onChange={handleControlledInputChange} required className="form-control" placeholder="Location address" defaultvalue={location.address}/>
        </div>
      </fieldset>
